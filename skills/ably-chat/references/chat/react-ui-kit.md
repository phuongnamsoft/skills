...
![Ably Chat React App](https://raw.githubusercontent.com/ably/docs/main/src/images/examples/chat-ui-app.png)

## Components and Providers

The React UI Kit is organized into two main categories:

* [Components](https://ably.com/docs/chat/react-ui-kit/components.md) - UI components for building chat interfaces
* [Providers and their Hooks](https://ably.com/docs/chat/react-ui-kit/providers.md) - Context providers and hooks for managing state
...
* Check out the [getting started guide](https://ably.com/docs/chat/getting-started/react-ui-kit.md) for using Ably Chat with React UI Components.
