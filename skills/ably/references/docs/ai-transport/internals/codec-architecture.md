...
See the [Codec API reference](https://ably.com/docs/ai-transport/api-reference/codec.md) for the full interface specification.

## Related pages 

- [Wire protocol](https://ably.com/docs/ai-transport/internals/wire-protocol.md) - the message format the codec reads and writes.
- [Conversation tree](https://ably.com/docs/ai-transport/internals/conversation-tree.md) - how decoded messages build the tree.
- [Transport patterns](https://ably.com/docs/ai-transport/internals/transport-patterns.md) - how the transport layer drives the codec.
- [Codec API reference](https://ably.com/docs/ai-transport/api-reference/codec.md) - the public codec interface.
