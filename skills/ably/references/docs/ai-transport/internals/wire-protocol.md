...
- [Codec architecture](https://ably.com/docs/ai-transport/internals/codec-architecture.md) - how the codec uses the wire protocol to encode and decode messages.
- [Conversation tree](https://ably.com/docs/ai-transport/internals/conversation-tree.md) - how `x-ably-parent` and `x-ably-fork-of` build the tree structure.
- [Optimistic updates](https://ably.com/docs/ai-transport/features/optimistic-updates.md) - reconciliation from the user's perspective.
