...
- For a `message` event it will be a [Message](https://ably.com/docs/api/realtime-sdk/types.md#message) object
- For a `presence` event it will be a [PresenceMessage](https://ably.com/docs/api/realtime-sdk/types.md#presence-message) object
- For an `error` event it will be an [ErrorInfo](https://ably.com/docs/api/realtime-sdk/types.md#error-info) object
