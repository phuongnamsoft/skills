...
### <If lang="javascript,nodejs,java">DeviceDetails</If><If lang="objc,swift">ARTDeviceDetails</If> 
...
| <If lang="java,objc,swift">push.errorReason</If><If lang="javascript,nodejs">push.error</If> | When the device's state is failing or failed, this attribute contains the reason for the most recent failure | [`ErrorInfo`](https://ably.com/docs/api/realtime-sdk/types.md#error-info) |
...
### <If lang="javascript,nodejs">PushChannelSubscription</If><If lang="java">ChannelSubscription</If><If lang="objc,swift">ARTPushChannelSubscription</If> 
...
### <If lang="javascript,nodejs">PaginatedResult</If><If lang="objc,swift">ARTPaginatedResult</If><If lang="java">io.ably.lib.types.PaginatedResult</If> 
