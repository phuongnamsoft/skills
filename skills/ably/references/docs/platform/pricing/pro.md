...
* [DataDog Lite](https://ably.com/docs/platform/integrations/streaming/datadog.md#lite)
...
[Compare the limits](https://ably.com/docs/platform/pricing/limits.md) associated with each package to see those available on the Pro package.
...
To upgrade your account from a Pro package, [contact us](https://ably.com/contact?cta=enterprise_package) to discuss [Enterprise package](https://ably.com/docs/platform/pricing/enterprise.md) options.
...
If you downgrade to the [Free package](https://ably.com/docs/platform/pricing/free.md), you will remain on the Pro package with its limits and benefits until the end of your billing cycle (on the 1st of the month). At the start of the following month, you will receive a final invoice that includes the full Pro package fee and any usage for the previous month.

If you downgrade to the [Standard package](https://ably.com/docs/platform/pricing/standard.md), you will remain on the Pro package with its limits and benefits until the end of your billing cycle (on the 1st of the month). At the start of the following month, you will receive a final invoice that includes the full Pro package fee and any usage for the previous month.
